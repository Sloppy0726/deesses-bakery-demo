...
(function () {
  ...
  var COPY = {
    en: {
      ...
      customerReviewsTitle: "Loved by our customers.",
      customerReviewsCopy: "Placeholder for approved customer praise and review photos. Real screenshots can be added here later.",
      customerReviewsAria: "Customer review placeholders",
      customerReviewPlaceholderOne: "Review image placeholder",
      customerReviewPlaceholderTwo: "Customer praise placeholder",
      customerReviewPlaceholderThree: "Social proof placeholder",
      customerReviewPlaceholderCopy: "Waiting for approved customer feedback screenshots.",
    ...
    zh: {
      ...
      customerReviewsTitle: "顧客喜歡的甜蜜時刻。",
      customerReviewsCopy: "預留位置放已批准的客人好評和回圖；之後可加入真實截圖。",
      customerReviewsAria: "客人好評預留位置",
      customerReviewPlaceholderOne: "好評圖片預留位置",
      customerReviewPlaceholderTwo: "客人評語預留位置",
      customerReviewPlaceholderThree: "社交回圖預留位置",
      customerReviewPlaceholderCopy: "等待加入已批准的客人好評截圖。",
