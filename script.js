...
(function () {
  ...
  var COPY = {
    ...
    zh: {
      ...
      orderNow: "立即訂購",
      onlineOrdering: "甜點預訂",
      homeHeroTitle: "甜蜜時刻<br />細緻包好",
      homeHeroCopy: "由慶祝蛋糕、酥香小點到每日新鮮麵包，每一個系列都以送禮感與手作溫度細緻呈現。",
      viewProductSpotlights: "挑選甜點系列 <span aria-hidden=\"true\">♡</span>",
      howItWorks: "訂購流程",
      artemisSignature: "Artemis 禮盒靈感",
      artemisTitle: "啟德的粉紫甜點櫃。",
      artemisCopy: "AIRSIDE Artemis 以粉紫色調包裝每日新鮮麵包、麻糬牛角酥與慶祝蛋糕，適合即興送禮，也適合慢慢挑選。",
      viewArtemisPicks: "看看 Artemis 推介",
      productSpotlight: "甜點系列",
      productSpotlightTitle: "先選一個想送出的味道。",
      productSpotlightCopy: "慶祝蛋糕、精緻酥點與日常麵包分成三個系列；不用在長餐單裡找，直接進入想看的甜點世界。",
      ...
      cakePageTitle: "為重要日子留一份甜。",
      cakePageCopy: "瀏覽慶祝蛋糕、迷你蛋糕與節日推介，再把想要的口味、尺寸和祝福語發送查詢。",
      shopCakes: "挑選蛋糕",
      shopCakesCopy: "按分店查看蛋糕供應；想做專屬款式，可在下方填寫自訂蛋糕查詢。",
      pastryCollection: "法式酥點系列",
      pastryPageTitle: "酥香小禮，剛好帶走。",
      pastryPageCopy: "從麻糬牛角酥到精緻小點，挑一盒適合下午茶或送禮的甜。",
      shopPastries: "挑選酥點",
      shopPastriesCopy: "按分店瀏覽酥點供應，打開產品詳情後即可用 WhatsApp 查詢預訂。",
      breadCollection: "新鮮麵包系列",
      breadPageTitle: "每日出爐的柔軟香氣。",
      breadPageCopy: "酸種包、法包與日常麵包，為早餐、分享與簡單心情準備。",
      shopBreads: "挑選麵包",
