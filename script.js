...
(function () {
  ...
  var COPY = {
    en: {
      ...
      signaturePistachioMochiCroissant: "Pistachio mochi croissant",
      signatureMiniRainbowCroissants: "Mini rainbow croissants",
      signatureBearCake: "Bear cake",
      ...
      customerReviewsEyebrow: "Customer Reviews",
      customerReviewsTitle: "Sweet notes from customers.",
      customerReviewsCopy: "A reserved area for real review screenshots, thank-you messages and reposts once they are approved.",
      customerReviewsAria: "Customer review placeholders",
      customerReviewPlaceholderOne: "“Add a customer screenshot here.”",
      customerReviewPlaceholderTwo: "“Add a short thank-you message here.”",
      customerReviewPlaceholderThree: "“Add a tagged customer repost here.”",
      customerReviewPlaceholderMetaOne: "Review image placeholder · IG story / WhatsApp",
      customerReviewPlaceholderMetaTwo: "Customer praise placeholder · Birthday / gifting",
      customerReviewPlaceholderMetaThree: "Social proof placeholder · Tagged photo",
      ...
      legalRights: "© 2026 DÉESSES Bakery. All rights reserved.",
      privacyPolicy: "Privacy Policy",
      termsConditions: "Terms & Conditions",
      solaraCredit: "Website created by <a href=\"https://solara.hk\" target=\"_blank\" rel=\"noopener\">Solara.hk</a>",
      privacyPolicyTitle: "Privacy Policy",
      privacyPolicyCopy: "Placeholder privacy policy text. Replace this section with the final business privacy policy before launch.",
      termsConditionsTitle: "Terms & Conditions",
      termsConditionsCopy: "Placeholder terms and conditions text. Replace this section with the final business terms before launch.",
    ...
    zh: {
      ...
      orderNow: "立即訂購",
      onlineOrdering: "甜點預訂",
      homeHeroTitle: "把心意焗成<br />甜蜜時刻",
      homeHeroCopy: "蛋糕、酥點與新鮮麵包，由日常小禮到慶祝時刻，都以手作細節溫柔呈現。",
      viewProductSpotlights: "挑選甜點系列 <span aria-hidden=\"true\">♡</span>",
      howItWorks: "訂購流程",
      artemisSignature: "Artemis 禮盒靈感",
      artemisTitle: "啟德的粉紫禮物櫃。",
      artemisCopy: "AIRSIDE Artemis 以粉紫色調包裝每日新鮮麵包、麻糬牛角酥與慶祝蛋糕，想即興送禮或慢慢挑選都剛好。",
      viewArtemisPicks: "看看 Artemis 推介",
      signaturePistachioMochiCroissant: "開心果麻糬牛角酥",
      signatureMiniRainbowCroissants: "迷你彩虹牛角酥",
      signatureBearCake: "小熊蛋糕",
      productSpotlight: "甜點系列",
      productSpotlightTitle: "為今天挑一份甜。",
      productSpotlightCopy: "慶祝蛋糕、精緻酥點與日常麵包分成三個系列；少一點翻找，多一點挑選的心情。",
      productSpotlightAria: "產品分類系列",
      cakeSpotlight: "慶祝蛋糕",
      pastrySpotlight: "酥點小禮",
      breadSpotlight: "日常麵包",
      cakesPlural: "蛋糕",
      pastriesPlural: "酥點",
      breadsPlural: "麵包",
      cakesSpotlightCopy: "生日、紀念日與驚喜時刻的慶祝蛋糕，由尺寸到口味都可以慢慢構想。",
      pastriesSpotlightCopy: "麻糬牛角酥、迷你酥點與甜點小禮，適合下午茶，也適合漂亮地帶走。",
      breadsSpotlightCopy: "酸種包、法包與日常麵包，保留剛出爐的樸實香氣。",
      viewCakes: "進入蛋糕系列",
      viewPastries: "進入酥點系列",
      viewBreads: "進入麵包系列",
      ...
      customerReviewsEyebrow: "客人好評",
      customerReviewsTitle: "客人留下的甜蜜好評。",
      customerReviewsCopy: "預留位置放已批准的客人好評截圖、感謝訊息和社交回圖；之後可直接替換成真實內容。",
      customerReviewsAria: "客人好評預留位置",
      customerReviewPlaceholderOne: "「這裡放客人好評截圖。」",
      customerReviewPlaceholderTwo: "「這裡放簡短感謝訊息。」",
      customerReviewPlaceholderThree: "「這裡放客人標記回圖。」",
      customerReviewPlaceholderMetaOne: "好評圖片預留 · IG story / WhatsApp",
      customerReviewPlaceholderMetaTwo: "客人評語預留 · 生日／送禮",
      customerReviewPlaceholderMetaThree: "社交回圖預留 · Tagged photo",
      ...
      legalLinksAria: "法律連結",
      legalRights: "© 2026 DÉESSES Bakery. 版權所有。",
      privacyPolicy: "私隱政策",
      termsConditions: "條款及細則",
      solaraCredit: "網站由 <a href=\"https://solara.hk\" target=\"_blank\" rel=\"noopener\">Solara.hk</a> 製作",
      privacyPolicyTitle: "私隱政策",
      privacyPolicyCopy: "私隱政策內容預留位置。正式上線前，請替換成店舖最終版本。",
      termsConditionsTitle: "條款及細則",
      termsConditionsCopy: "條款及細則內容預留位置。正式上線前，請替換成店舖最終版本。",
      legalBackHome: "返回首頁",
      cakeCollection: "慶祝蛋糕系列",
      cakePageTitle: "為重要日子，留一份甜。",
      cakePageCopy: "瀏覽慶祝蛋糕、迷你蛋糕與節日推介，再把口味、尺寸和祝福語一起發送查詢。",
      shopCakes: "挑選蛋糕",
      shopCakesCopy: "按分店查看蛋糕供應，打開產品詳情後即可用 WhatsApp 查詢預訂。",
      pastryCollection: "法式酥點系列",
      pastryPageTitle: "酥香小禮，漂亮帶走。",
      pastryPageCopy: "從麻糬牛角酥到精緻小點，挑一盒適合下午茶、探訪或送禮的甜。",
      shopPastries: "挑選酥點",
      shopPastriesCopy: "按分店瀏覽酥點供應，打開產品詳情後即可用 WhatsApp 查詢預訂。",
      breadCollection: "新鮮麵包系列",
      breadPageTitle: "每日出爐，一口柔軟。",
      breadPageCopy: "酸種包、法包與日常麵包，為早餐、分享與平凡日子加一點香氣。",
      shopBreads: "挑選麵包",
      shopBreadsCopy: "專屬麵包系列，按分店查看供應，再發送查詢預留新鮮出爐款式。",
      menuCollection: "餐單系列",
